...
from dpss.exceptions import RedundantMessageError, AbandonedNodeError
...
async def tylerba(sid, pid, node_ids, f, coin_keys, input_msg, decide, broadcast, receive):
    ...
    async def _coin(r, coin_init):
        ...
        for kk in rbc_values:
            ...
            for i in range(len(coeffs)):
                coeffs[i] *= commitments[0][i] #TODO: Optimize this
...
if __name__ == "__main__":
    import pickle
    import base64
    from dpss.config import HbmpcConfig
    from dpss.ipc import ProcessProgramRunner
    from dpss.broadcast.crypto.boldyreva import TBLSPublicKey  # noqa:F401
    from dpss.broadcast.crypto.boldyreva import TBLSPrivateKey  # noqa:F401

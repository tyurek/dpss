...
class TestPreProcessing:
    ...
    def __init__(self):
        ...
        from dpss.preprocessing import PreProcessingConstants as Constants
        from dpss.progs.mixins.base import MixinBase
...
class TestRouter(SimpleRouter):
    ...
    def send(self, player_id: int, dest_id: int, message: object):
        ...
        #print(f"[message]({player_id} to {dest_id}): {message}")
